                ...
                child: FilledButton(
                  ...
                  style: FilledButton.styleFrom(
                    ...
                    disabledBackgroundColor:
                        const Color(0xFF6B21D4).withOpacity(0.45),
...
class _OrDivider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        const Expanded(
          child: Divider(color: Color(0xFFCCBBEE), thickness: 1),
        ),
        Padding(
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            errorStyle: const TextStyle(
              fontSize: 0, // hide default error text — we render it ourselves below
              height: 0,
            ),
