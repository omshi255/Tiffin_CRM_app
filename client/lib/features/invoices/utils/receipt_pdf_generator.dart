              ...
              children: [
                ...
                pw.Container(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text('Customer Code: ${customer['customerCode'] ?? '—'}'),
                      pw.Text(
                        'Subscription: ${subscription['planName'] ?? ''} (${subscription['planType'] ?? ''})',
                      ),
                      pw.Text('Delivery Slot: ${subscription['deliverySlot'] ?? ''}'),
                    ],
                  ),
                ),
                pw.SizedBox(height: 10),
                      ...
                      children: [
                        ...
                        pw.Align(
                          ...
                          child: pw.Padding(
                            ...
                            child: pw.Text(
                              'Slot subtotal: ${_money.format(_num(slot['slotTotal']))}',
                              style: pw.TextStyle(fontWeight: pw.FontWeight.bold),
                            ),
                          ),
                        ),
                ...
                pw.Center(
                  child: pw.Text(
                    ...
                    style: pw.TextStyle(color: _pdfColor(AppColors.textSecondary)),
                  ),
                ),
              ],
            ),
