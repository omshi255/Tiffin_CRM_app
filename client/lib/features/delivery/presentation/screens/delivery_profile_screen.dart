...
class _DeliveryProfileScreenState extends State<DeliveryProfileScreen> {
  ...
  Widget build(BuildContext context) {
    if (_loading) {
      return Center(child: CircularProgressIndicator(
          color: _violet600, strokeWidth: 2.5));
    }
            ...
            Stack(clipBehavior: Clip.none, children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(16),
                  border: Border.all(
                    color: isActive ? _border : _border,
                  ),
                ),
                child: Center(
                  child: Text(initials,
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Text(
                      isActive ? 'Available for delivery' : 'Currently inactive',
                      style: TextStyle(
        ...
        if (_updatingActive)
          const SizedBox(width: 24, height: 24,
            child: CircularProgressIndicator(
                strokeWidth: 2, color: _violet600))
        else
          GestureDetector(
  ...
  Widget _infoRow(
      IconData icon, String label, String value, bool isFirst) =>
      Padding(
        padding: const EdgeInsets.symmetric(
  ...
  Widget _sectionLabel(String text) => Row(children: [
    Container(
      width: 3, height: 14,
      decoration: BoxDecoration(
        color: _violet600, borderRadius: BorderRadius.circular(2)),
    ),
    const SizedBox(width: 8),
    Text(text.toUpperCase(),
      style: const TextStyle(
        fontSize: 10, fontWeight: FontWeight.w700,
        color: _textSecondary, letterSpacing: 1.2,
      )),
  ]);
}